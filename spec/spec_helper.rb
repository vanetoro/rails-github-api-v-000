...
#       with(:headers => {'Authorization'=>'token 1','Accept'=>'application/json'}).
...
#       :headers => {'Accept'=>'application/json','Authorization'=>'token 1'}).
...
#       :headers => {'Authorization'=>'token 1','Accept'=>'application/json'}).
